...
/// </summary>
public class MonthBehaviour : MonoBehaviour
{    
    /// <summary>
    ...
    private TextMeshProUGUI textMonth;
    ...
    void Start()
    {
        ...
        textMonth = gameObject.GetComponentInChildren<TextMeshProUGUI>();
        textMonth.text = "";
    }
    ...
    // GESTIONE INSERIMENTO MESE
    public void SetMonth(string input)
    {        
        if (isSelected)
        {
            textMonth.text = input;
            month = input;
            DeselectMe();
        }
    }
